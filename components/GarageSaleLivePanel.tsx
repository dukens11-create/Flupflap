...
const CAMERA_PERMISSION_HELP_MESSAGE = 'Allow camera access in your browser settings, then tap the retry button below. On Android Chrome, open Site settings → Camera → Allow.';
