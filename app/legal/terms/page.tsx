  ...
  return (
    <main className="max-w-3xl mx-auto space-y-6">
      ...
      <section>
        ...
        <p className="text-slate-700">Under these Terms, FlupFlap charges a 7% platform commission on each completed sale. This fee is deducted from the seller payout and stored with paid order items for audit and payout reporting.</p>
      </section>
