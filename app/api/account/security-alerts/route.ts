...
export async function GET() {
  try {
    ...
    logError('Failed to load account security alerts', err, { tag: 'account/security-alerts/GET' });
    return NextResponse.json({ error: 'Unable to load security alerts right now.' }, { status: 500 });
  }
}
