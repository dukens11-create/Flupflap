        ...
        <div className="border-t border-slate-100 pt-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input name="pickupCity" className="input" defaultValue={product.pickupCity ?? ''} placeholder="e.g. Brooklyn" />
            </div>
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="label">State</label>
                <input name="pickupState" className="input" defaultValue={product.pickupState ?? ''} placeholder="e.g. NY" maxLength={2} />
              </div>
              <div className="flex-1">
                <label className="label">ZIP code</label>
                <input name="pickupPostalCode" className="input" defaultValue={product.pickupPostalCode ?? ''} placeholder="e.g. 11201" maxLength={10} />
              </div>
            </div>
