        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-xs text-slate-500">
              Paid approved/expired listings are directly eligible once started, while hidden or archived paid listings can still be granted through admin override when business-approved.
