...
export const DEFAULT_CATEGORY_TREE: DefaultCategoryNode[] = [
  ...
  node({ id: 'caribbean-products', name: 'Caribbean Products', slug: 'caribbean-products', aliases: ['caribbean', 'caribbean products', 'island products', 'west indies'], parentId: null, level: 0, icon: '🏝️', sortOrder: 10, attributeSchema: null, children: [
    ...
    node({ id: 'caribbean-products-beauty-hair', name: 'Caribbean Beauty & Hair', slug: 'caribbean-products-beauty-hair', aliases: ['caribbean beauty', 'caribbean hair', 'island beauty'], parentId: 'caribbean-products', level: 1, icon: null, sortOrder: 7, attributeSchema: PERFUME_FIELDS }),
