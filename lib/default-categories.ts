...
export const DEFAULT_CATEGORY_TREE: DefaultCategoryNode[] = [
  ...
  node({ id: 'health-wellness', name: 'Health & Wellness', slug: 'health-wellness', aliases: ['health', 'wellness', 'self care', 'supplements'], parentId: null, level: 0, icon: '🧘', sortOrder: 8, attributeSchema: BEAUTY_SKINCARE_FIELDS, children: [
    ...
    node({ id: 'health-wellness-intimate-wellness', name: 'Intimate Wellness', slug: 'health-wellness-intimate-wellness', aliases: ['intimate wellness', 'adult wellness', 'sexual wellness', 'sex toys', 'personal massagers', 'couples wellness'], parentId: 'health-wellness', level: 1, icon: '💜', sortOrder: 4, attributeSchema: BEAUTY_SKINCARE_FIELDS, children: [
      node({ id: 'health-wellness-intimate-wellness-personal-massagers', name: 'Personal Massagers', slug: 'health-wellness-intimate-wellness-personal-massagers', aliases: ['massagers', 'vibrators', 'devices'], parentId: 'health-wellness-intimate-wellness', level: 2, icon: null, sortOrder: 1, attributeSchema: BEAUTY_SKINCARE_FIELDS }),
      node({ id: 'health-wellness-intimate-wellness-lubricants-care', name: 'Lubricants & Care', slug: 'health-wellness-intimate-wellness-lubricants-care', aliases: ['lubricants', 'care', 'wellness essentials'], parentId: 'health-wellness-intimate-wellness', level: 2, icon: null, sortOrder: 2, attributeSchema: BEAUTY_SKINCARE_FIELDS }),
      node({ id: 'health-wellness-intimate-wellness-accessories-storage', name: 'Accessories & Storage', slug: 'health-wellness-intimate-wellness-accessories-storage', aliases: ['accessories', 'storage', 'cleaning'], parentId: 'health-wellness-intimate-wellness', level: 2, icon: null, sortOrder: 3, attributeSchema: BEAUTY_SKINCARE_FIELDS }),
    ] }),
  ] }),
